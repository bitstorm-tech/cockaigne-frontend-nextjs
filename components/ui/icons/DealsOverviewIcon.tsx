export default function DealsOverviewIcon({ size = 1.5 }) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 141.732 141.732" fill="currentColor" stroke="currentColor" style={style}>
      <rect width="86.133" height="100.267" x="33.437" y="24.068" fill="none" strokeMiterlimit="10" strokeWidth="6" rx="10.933" />
